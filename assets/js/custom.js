...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (data.status == "success") {
                    let s = '';
                    s = '<button type="button" class="close" id="closebtnid">&times;</button><strong>Registeration Successful!</strong>';
                    ...
                    let s = '';
                    s = '<button type="button" class="close" id="closebtnid" data-dismiss="alert">&times;</button><strong>Registeration Unsuccessful!</strong>';
                    $('#successalert').addClass('alert alert-danger alert-dismissible fade show');
                    $('#successalert').html(s);
                }
            },
            error: function (errres) {
                ...
                $("#erroralertdiv").html(str);
            }
        });
    });

    // $("#enablebtnid").click(function () {
    //     $("#signupid").attr("disabled", false);
    // });
    ...
    $("#loginbtnid").click(function (e) {
        e.preventDefault();
        let email = $("#recipient-emaillogin").val();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (res.status == "success") {
                    ...
                    let str = "<button type='button' class='close' id='btnalertclose'>&times;</button><strong>Invalid Login Details</strong>";
                    $('#loginerror').addClass("alert alert-danger alert-dismissible");
                    $('#loginerror').html(str);
                }
            },
            error: function (errres) {
                ...
                $("#loginfielderrors").html(str);
            }
        });
    });

    $("#mcploginbtnid").click(function () {
        console.log("butnn");
        let email = $("#mcpemailid").val();
        let password = $("#mcppasswordid").val();
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (response.status == "success") {
                    ...
                    let str = "<button type='button' class='close' id='btnalertclose'>&times;</button><strong>Invalid Login Details</strong>";
                    $('#mcpinvaliderrdiv').addClass("alert alert-danger alert-dismissible");
                    $('#mcpinvaliderrdiv').html(str);
                }
            },
            error: function (errres) {
                let errors = errres.responseJSON.errors;
